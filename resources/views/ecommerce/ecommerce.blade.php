...
{{-- Hero --}}
<section class="bg-center bg-no-repeat pb-10" style="background-image: url('{{ asset('./image/hero-image-ecommerce.png') }}')">
    <div class="max-w-screen-xl place-items-start text-left pt-56 fade-hero">
        <div class="pt-60 lg:px-25 md:px-10 sm:px-10 max-[640px]:px-10">
            <h1 class="mb-4 font-ppbold tracking-tight leading-none text-white md:text-5xl lg:text-6xl hero-text">Marketplace</h1>
            <h1 class="mb-4 font-ppbold tracking-tight leading-none text-white md:text-5xl lg:text-6xl hero-text">& Order</h1>
            <p class="lg:w-100 md:w-100 sm:w-auto mb-8 lg:text-base md:text-sm sm:text-sm max-[640px]:text-xs lato-regular font-lato text-white">Buat pesanan anda sekarang melalui Tokopedia dan Whatsapp untuk Luar kota dan dalam kota.</p>
        </div>
    </div>
</section>
            ...
            <div class="py-5">
                ...
                <div class="space-y-4 mb-5 my-10 sm:flex-row sm:justify-end sm:space-y-0">
                    <a href="https://www.instagram.com/cikopimangeko?igsh=MWJlNTNmaHBoeHJ4dQ==" class="inline-flex justify-end items-center py-3 px-5 font-lato lato-bold lg:text-base md:text-sm sm:text-sm max-[640px]:text-xs text-center text-[#FFFEF4] rounded-lg bg-[#39312F] hover:bg-[#1c1817] transition duration-500 ease-out hover:scale-105">
                        Lebih Lanjut
                        <img class="ms-3" src="{{ asset('./image/arrow-white.png') }}" alt="arrow-white">
                    </a>
                </div>
            </div>
        </div>
