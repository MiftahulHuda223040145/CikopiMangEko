...
<div class="font-lato lg:px-25 md:px-10 sm:px-10 max-[640px]:px-10 max-w-screen-xl place-items-start text-left py-15 fade-in-up">
    <div class="">
        <h1 class="lg:text-4xl md:text-4xl sm:text-2xl max-[640px]:text-2xl font-bold text-[#39312F]">ABOUT US</h1>
...
<div class="font-lato lg:gap-20 md:gap-20 max-[640px]:gap-10 sm:gap-10 justify-center place-items-start grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 max-w-screen text-left py-15 my-10 lg:px-30 md:px-10 sm:px-10 max-[640px]:px-10 fade-in-up">
    <div class="">
        <img class="w-auto rounded-3xl transform transition duration-500 ease-out hover:scale-105" src="{{ asset('storage/image/foto-acehgayo.png') }}" alt="">
    </div>
    <div class="">
        <h1 class="lg:text-4xl md:text-4xl sm:text-2xl max-[640px]:text-2xl font-bold text-[#39312F]">PRODUCT</h1>
...
<div class="container max-w-screen lg:px-25 md:px-10 sm:px-10 max-[640px]:px-10 fade-in-up">
    <div class="font-lato max-w-screen-xl place-items-start text-left py-3">
        <div class="">
            <h1 class="lg:text-4xl md:text-4xl sm:text-2xl max-[640px]:text-2xl font-bold text-[#39312F]">ECOMMERCE</h1>
...
{{-- News --}}
<div class="container max-w-screen mb-25 fade-in-up">
    <div class="font-lato place-items-start text-left mt-15">
        <div class="">
            <h1 class="lg:text-4xl md:text-4xl sm:text-2xl max-[640px]:text-2xl font-bold text-[#39312F]">NEWS</h1>
    ...
    <div class="font-lato gap-10 justify-center grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 place-items-start text-left py-3">
        <div class="">
            <img class="w-auto rounded-3xl transform transition duration-500 ease-out hover:scale-105" src="{{ asset('storage/image/cikopi-news1.png') }}" alt="">
        </div>
        <div class="">
