...
<div class="container max-w-screen my-15 font-lato fade-in-up">
    <div class="lg:px-25 md:px-25 sm:px-10 max-[640px]:px-10 lg:grid grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-8 justify-center">
        <div class="mb-8">
            <div class="h-70 rounded-4xl bg-cover bg-center" style="background-image: url('{{ asset('storage/image/cikopi-news1.png') }}')"></div>
        ...
        <div class="">
            <h1 class="lg:text-3xl md:text-3xl sm:text-2xl max-[640px]:text-2xl font-bold text-[#39312F] mb-5">Berita Terbaru</h1>
            <div class="mb-10">
